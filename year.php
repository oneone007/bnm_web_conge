...
$page_identifier = 'Annual_Recap_V';
...
<div class="search-controls bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md mb-6">
  ...
  <div>
    <label for="recap_client" class="block text-sm font-medium recap-label">Client</label>
    <div class="relative">
...
<div class="table-wrapper mt-6">
  <!-- Year 2022 -->
  <div class="table-container rounded-lg bg-white shadow-md dark:bg-gray-900 mb-6" data-year="2022">
  ...
  <!-- Year 2023 -->
  <div class="table-container rounded-lg bg-white shadow-md dark:bg-gray-900 mb-6" data-year="2023">
  ...
  <!-- Year 2024 -->
  <div class="table-container rounded-lg bg-white shadow-md dark:bg-gray-900 mb-6" data-year="2024">
  ...
  <!-- Year 2025 -->
  <div class="table-container rounded-lg bg-white shadow-md dark:bg-gray-900 mb-6" data-year="2025">
  ...
  <div class="chart-controls bg-white dark:bg-gray-900 p-4 rounded-lg shadow-md mb-6">
    <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
      <div>
        ...
        <select id="chart-type" class="w-full p-2 border rounded dark:bg-gray-900 dark:border-gray-700">
...
// Constants
const API_ENDPOINTS = {
  fetchData: API_CONFIG.getApiUrl('/fetchFournisseurDataByYear'),
  listFournisseur: API_CONFIG.getApiUrl('/listfournisseur'),
  listProduct: API_CONFIG.getApiUrl('/listproduct'), // Added product endpoint
  listClient: API_CONFIG.getApiUrl('/listclient'),
  listZone: API_CONFIG.getApiUrl('/listregion')
};
const monthNames = {
...
function exportTablesToPDF() {
  try {
    ...
    let filename = 'Annual_Recap_vente';
