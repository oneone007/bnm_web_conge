...
$page_identifier = 'ETAT_F_CUMULE_PAIMENT';
    ...
    <div id="content" class="content flex-grow p-4">
        <div class="flex justify-center items-center mb-6">
            <h1 class="text-5xl font-bold dark:text-white text-center">
                État des Paiements Fournisseur
            </h1>
        </div>
...
<div class="table-container rounded-lg bg-white shadow-md dark:bg-gray-800">
    <div class="overflow-x-auto">
        <!-- Header Row with Title and Total Transactions -->
        <div class="grid grid-cols-3 items-center mb-2 px-4">
            ...
            <!-- Right-aligned Total Transactions -->
    ...
    <script>
        ...
        async function fetchSupplierTransactions() {
            ...
            try {
                ...
                const url = new URL(API_CONFIG.getApiUrl("/fetch_etat_fournisseur_cumule_paiment"));
